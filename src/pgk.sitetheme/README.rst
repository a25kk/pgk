...
Site theme package for the pgk project based on Diazo and
plone.app.theming

* `Source code @ GitHub <https://github.com/kreativkombinat/pgk.sitetheme>`_
* `Releases @ PyPI <http://pypi.python.org/pypi/pgk.sitetheme>`_
* `Continuous Integration @ Travis-CI <http://travis-ci.org/kreativkombinat/pgk.sitetheme>`_
